...
class BlackWhiteDatabaseHelper extends OrmLiteSqliteOpenHelper {
    private static final String TABLE_NAME = "black_white.db";
    private static BlackWhiteDatabaseHelper instance;
    private Map<String, Dao> daoMap = new HashMap<>();

    private BlackWhiteDatabaseHelper(Context context) {
     ...
     * @return
     */
    public static BlackWhiteDatabaseHelper getInstance(Context context) {
        if (instance == null) {
            synchronized (BlackWhiteDatabaseHelper.class) {
                if (instance == null) {
                    instance = new BlackWhiteDatabaseHelper(context);
                }
            }
        }
        return instance;
